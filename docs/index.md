# go-ruby-grape documentation

**Pure-Go, MRI-faithful Ruby grape (no cgo)**

`go-ruby-grape/grape` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `grape`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-grape/grape`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `grape`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`grape`](https://github.com/go-ruby-grape/grape) | the library — Ruby's `grape` in pure Go |
| [`docs`](https://github.com/go-ruby-grape/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-grape.github.io`](https://github.com/go-ruby-grape/go-ruby-grape.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-grape/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-grape/grape](https://github.com/go-ruby-grape/grape).
