...
`go-ruby-grape/grape` reimplements Ruby's `grape` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-grape/grape` directly, with no Ruby runtime;
