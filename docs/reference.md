...
The public API lives at the module root (`github.com/go-ruby-grape/grape`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `grape`, while the surface follows
...
```go
import "github.com/go-ruby-grape/grape"
```
...
- **[pkg.go.dev/github.com/go-ruby-grape/grape](https://pkg.go.dev/github.com/go-ruby-grape/grape)**

The module's [README](https://github.com/go-ruby-grape/grape#readme) carries worked
